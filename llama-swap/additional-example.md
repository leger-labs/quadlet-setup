...
Benson Wong edited this page on Aug 23 · 17 revisions
Full Config Example
Note

This configuration example is formatted for both LLMs and humans to understand. Try copying / pasting it into your prompt and asking your LLM questions.

Important

The most up to date configuration will always be config.example.yaml.
